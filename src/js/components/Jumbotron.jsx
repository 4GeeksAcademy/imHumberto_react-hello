    ...
    return (
        <div className="container my-5">
            <div className="p-5 text-center bg-body-tertiary rounded-3">
                <svg className="bi mt-4 mb-3" width="100" height="100" aria-hidden="true"><use xlinkHref="#bootstrap"></use></svg>
                ...
                <div className="d-inline-flex gap-2 mb-5">
                    <button className="d-inline-flex align-items-center btn btn-primary btn-lg px-4 rounded-pill" type="button">
                        Call to action
                        <svg className="bi ms-2" width="24" height="24" aria-hidden="true"><use xlinkHref="#arrow-right-short"></use></svg>
                    </button>
